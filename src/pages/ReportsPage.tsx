  ...
  return (
    <div>
      <div className="page-header">
        ...
        <p className="page-subtitle">Centro de reportes — click en cualquier reporte para ver el detalle</p>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        ...
        <MetricCard title="Rotación inventario" value="3.2x" icon={Package} variant="primary" href="/reportes/inventario" />
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        <div className="bg-card rounded-xl border p-5 cursor-pointer hover:shadow-lg transition-all" onClick={() => window.location.href = '/reportes/ventas'}>
          <h3 className="font-display font-semibold mb-4">Tendencia de ventas</h3>
