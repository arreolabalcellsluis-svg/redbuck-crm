          ...
          <div key={rec.id}
            ...
            <div className="flex flex-col lg:flex-row lg:items-center gap-4">
              ...
              <div className="flex flex-wrap gap-2 shrink-0">
                ...
                <button onClick={() => navigate('/crm/agenda', { state: { newActivityForCustomer: { customerId: rec.id, customerName: rec.customerName, vendorName: rec.vendorName, suggestedProduct: rec.suggestedProduct } } })}
